...
using Plcway.Communication.Serial;

namespace Plcway.Communication.Ethernet.Profinet.Omron
{
	/// <summary>
	...
	public class OmronHostLinkCMode : SerialDeviceBase
	{
		...
		{
			byte unitNumber = (byte)HslHelper.ExtractParameter(ref address, "s", UnitNumber);
