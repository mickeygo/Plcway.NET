...
namespace Plcway.Communication
{
	...
	/// </summary>
	/// <remarks>
	/// 当 <see cref="P:Plcway.Communication.OperateResult.IsSuccess" /> 为 True 时，
	/// 忽略 <see cref="P:Plcway.Communication.OperateResult.Message" /> 及 <see cref="P:Plcway.Communication.OperateResult.ErrorCode" /> 的值
	/// </remarks>
